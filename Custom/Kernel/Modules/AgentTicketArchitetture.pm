...
package Kernel::Modules::AgentTicketArchitetture;
...
my $Success = $BackendObject->ValueSet(
    ...
    my %Article = $TicketObject->ArticleLastCustomerArticle(
	 ...
	 my $ParentArticle = $TicketObject->ArticleCreate(
        ...
        Body             => 'Il ticket è stato scalato ad Architetture IT',                
        HistoryType      => 'Forward',                         
        HistoryComment   => 'Some free text!',
	    From             => 'Sistema OTRS',
	    Subject          => 'Il ticket è stato scalato ad Architetture IT',  
